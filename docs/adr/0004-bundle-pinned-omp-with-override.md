...
This also fixes the version strategy for multi-session support: the pin *is* the version. CI runs a protocol smoke suite against each new omp release before the bundled pin is bumped.
